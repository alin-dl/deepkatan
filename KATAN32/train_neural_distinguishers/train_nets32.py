...
def make_resnet(num_blocks=2, num_filters=32, num_outputs=1, d1=64, d2=64, word_size=32, ks=3, reg_param=0.0001, final_activation='sigmoid'):
  #Input and preprocessing layers
  inp = Input(shape=(32*32,))
  rs = Reshape((32, 32))(inp)
...
def train_katan_distinguisher(num_epochs,Round ,diff):
    ...
    X, Y = ka.make_train_data(10**7,Round,diff)
    X_eval, Y_eval = ka.make_train_data(10**6, Round,diff)
...
val_acc=train_katan_distinguisher(20, 84, 0x61082200)
